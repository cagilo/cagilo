...
class DeviceTest extends ComponentTestCase
{
    ...
    public function test_robot(): void
    {
    ...
    public function test_mobile(): void
    {
    ...
    public function test_desktop(): void
    {
    ...
    public function test_tablet(): void
    {
    ...
    public function test_combinate(): void
    {
    ...
    public function test_not_show(): void
    {
